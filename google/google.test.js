...
test('I can search Google', async () => {
    ...
    await searchBar.sendKeys(`What's Love Got to do with it movie\n`)
    ...
    await searchBar.sendKeys('The Photograh movie\n')

    await driver.sleep(2000) 
//add search for TV show
    searchBar = await driver.findElement(By.name('q'))
    await searchBar.clear() 

    await searchBar.sendKeys('Good Times tv show\n')
